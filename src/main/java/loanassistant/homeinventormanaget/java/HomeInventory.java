package loanassistant.homeinventormanaget.java;
import javax.swing.*;
...
try
{
PrintWriter outputFile = new PrintWriter(new BufferedWriter(newFileWriter("inventory.txt")));
...
edited = true;
if (!myInventory[currentEntry - 1].marked != markedCheckBox.isSelected())
edited = true;
...
{
// dividing line
Line2D.Double dividingLine;
    dividingLine = newLine2D.Double(pf.getImageableX(), y, pf.getImageableX() + pf.getImageableWidth(), y);
